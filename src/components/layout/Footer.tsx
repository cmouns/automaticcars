...
const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
    ...
    const filteredSocialLinks = SOCIAL_LINKS_DATA.filter((link: SocialLinkData) => 
        link.icon === 'Instagram' || link.icon === 'Tiktok' || link.icon === 'Snapchat'
    );
            ...
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-gray-400 font-light text-sm">
                            <li><button onClick={() => handleFooterLinkClick('fleet')} className="hover:text-white transition-colors">Nos Véhicules</button></li>
                            <li><button onClick={() => handleFooterLinkClick('subscription')} className="hover:text-white transition-colors">Services Exclusifs</button></li>
                            <li><button onClick={() => handleFooterLinkClick('lld')} className="hover:text-white transition-colors">Location Longue Durée</button></li>
                ...
                <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
                    ...
                    <div className="flex space-x-6 mt-4 md:mt-0">
                        <button onClick={() => handleFooterLinkClick('conditions')} className="hover:text-white transition-colors">Mentions Légales</button>
