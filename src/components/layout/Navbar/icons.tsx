...
// Icon Tiktok
export const TiktokIcon: React.FC<IconProps> = ({ className, width, height }) => (
  <svg
    viewBox="0 0 24 24"
    fill="currentColor"
    className={className}
...
// Icon Snapchat
export const SnapchatIcon: React.FC<IconProps> = ({ className, width, height }) => (
  <svg
    viewBox="0 0 48 48"
    fill="none"
    stroke="currentColor"
...
// Icon Instagram
export const InstagramIcon: React.FC<IconProps> = ({ className, width, height }) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
