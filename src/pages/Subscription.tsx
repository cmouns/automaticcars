...
const Subscription: React.FC = () => {
  ...
  return (
    <>
      {/* BALISES SEO */}
      <Helmet>
        <title>Club Privé & Abonnement - Automatic Cars</title>
        <meta
          name="description"
          content="Rejoignez le Club Privé Automatic Cars. Profitez de réductions exclusives, de cautions réduites et d'un accès VIP à notre flotte de véhicules de prestige."
        />
      </Helmet>
      ...
      <div className="font-sans selection:bg-gold-400 selection:text-black">
              ...
              <div>
                ...
                <p className="text-gray-700 text-lg font-light leading-relaxed mb-6">
                  ...
                  <strong className="text-dark-900 font-medium">
                    les cautions très élevées représentent le frein numéro 1 à
                    la location.
                  </strong>
                </p>
                <p className="text-gray-700 text-lg font-light leading-relaxed">
                  Certaines cautions peuvent atteindre plusieurs milliers
                  d’euros, ce qui limite fortement l’accès à notre flotte haut
                  de gamme, même pour des clients sérieux et solvables. Notre
                  abonnement supprime cette barrière.
                </p>
              </div>
          ...
          <div className="container mx-auto px-6 max-w-6xl">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-400 font-light">
                Des offres sur-mesure pour profiter de notre flotte toute
                l'année.
              </p>
            </div>
                ...
                <div className="flex justify-between items-start mb-6">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm font-light">
                      Idéale pour profiter régulièrement de nos véhicules
                      premium.
                    </p>
                  </div>
        ...
        {/* COMMENT ÇA MARCHE ET CONDITIONS */}
              ...
              <div className="space-y-12">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-center gap-2 text-gray-600 text-sm">
                      <Car size={16} className="text-dark-900" /> Expérience
                      haut de gamme reconnue
                    </li>
                  </ul>
                </div>
              </div>
