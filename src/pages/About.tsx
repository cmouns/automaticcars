...
const About: React.FC = () => {
  ...
  return (
    <>
      {/* BALISES SEO */}
      <Helmet>
        <title>Notre Histoire - Agence Automatic Cars Bordeaux</title>
        <meta
          name="description"
          content="Découvrez l'histoire d'Automatic Cars. Une agence de location de véhicules haut de gamme à Bordeaux, offrant un service premium et une livraison sur-mesure."
        />
      </Helmet>
      ...
      <div className="font-sans selection:bg-gold-400 selection:text-black">
        ...
        <section className="bg-dark-900 text-white pt-32 xl:pt-40 pb-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 max-w-4xl text-center relative z-10">
            <p className="text-sm md:text-base font-bold text-gold-400 uppercase tracking-[0.3em] mb-6">
              Notre Histoire
            </p>
            <h1 className="text-5xl md:text-7xl font-serif leading-tight text-white mb-8 drop-shadow-lg">
        ...
        {/* 2. HISTOIRE SECTION */}
        <section
          className="bg-cream py-24 relative"
          aria-labelledby="about-history-title"
        >
          <div className="container mx-auto max-w-5xl px-6">
            <h2 id="about-history-title" className="sr-only">
              L'évolution d'Automatic Cars
            </h2>
            ...
            <div className="bg-white border border-gold-500/20 rounded-2xl p-8 md:p-12 shadow-[0_10px_40px_-15px_rgba(218,175,55,0.15)] relative overflow-hidden">
              ...
              <div className="grid md:grid-cols-2 gap-12 text-gray-600 font-light leading-relaxed text-lg">
                <div className="space-y-6">
                  <p>
                    L’aventure{" "}
                    <strong className="text-dark-900 font-bold">
                      Automatic Cars
                    </strong>{" "}
                    a débuté en 2022 sous l'impulsion de Jad, entrepreneur et
                    véritable passionné d’automobile. Après deux années
                    d’expérience enrichissante dans la location entre
                    particuliers, l'objectif était clair : créer un service
                    innovant, entièrement pensé pour le confort absolu de nos
                    clients.
                  </p>
                  <p>
                    Aujourd’hui, le projet prend une nouvelle dimension avec
                    l’arrivée de Jules Foquet, professionnel expérimenté du
                    secteur. Ensemble, nous unissons nos forces pour développer
                    notre pôle haut de gamme et vous offrir une expérience
                    toujours plus prestigieuse.
                  </p>
                </div>

                <div className="space-y-6">
                  <p>
                    Nous vous accueillons désormais dans notre{" "}
                    <strong className="text-dark-900 font-bold">
                      nouvelle agence de plus de 350 m²
                    </strong>
                    , idéalement située à deux pas de la gare Saint-Jean à
                    Bordeaux.
                  </p>
                  <p>
                    Afin de garantir un service irréprochable et un suivi
                    sur-mesure, nous avons fait le choix privilégié de l'humain.
                    Nous ne proposons plus de récupération autonome, mais
                    continuons d'assurer{" "}
                    <strong className="text-dark-900 font-bold">
                      la livraison personnalisée de vos véhicules
                    </strong>{" "}
                    pour une flexibilité totale.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 pt-10 border-t border-gray-100">
                <div className="flex flex-col items-center text-center">
                  <ShieldCheck
                    ...
                    aria-hidden="true"
                  />
                  <h3 className="text-dark-900 font-bold tracking-wider uppercase text-sm mb-2">
                    Transparence
                  </h3>
                  <p className="text-sm text-gray-500">
                    Un service clair, sans frais cachés.
                  </p>
                </div>
                <div className="flex flex-col items-center text-center">
                  <MapPin
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-sm text-gray-500">
                    Livraison personnalisée du véhicule.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto max-w-7xl px-6">
            <div className="text-center mb-16">
              ...
              <div className="flex items-center justify-center gap-3 text-white font-medium text-lg">
                ...
                <div
                  className="flex text-[#FBBC04] space-x-1"
                  aria-label="Note de 4.7 sur 5 étoiles"
                >
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-lg ${review.bg}`}
                        aria-hidden="true"
                      >
